export default [
  {
    inputs: [
      ...
      { internalType: 'address[]', name: '_stablecoins', type: 'address[]' },
      { internalType: 'uint8', name: '_usdDecimals', type: 'uint8' },
    ],
  ...
  },
  {
    inputs: [
      ...
      { internalType: 'uint256', name: '_openVotingTime', type: 'uint256' },
    ],
    ...
    outputs: [
      {
        components: [
          ...
          { internalType: 'uint256', name: 'openVotingTime', type: 'uint256' },
        ],
  ...
  {
    inputs: [{ internalType: 'uint256', name: '_newRegistrationTime', type: 'uint256' }],
