export default [
  ...
  },
  {
    ...
    inputs: [
      { indexed: false, internalType: 'address', name: 'staker', type: 'address' },
      { indexed: false, internalType: 'uint256', name: 'stakeId', type: 'uint256' },
      { indexed: false, internalType: 'uint256', name: 'unstakeTime', type: 'uint256' },
      { indexed: false, internalType: 'bool', name: 'isUnstakedEarlier', type: 'bool' },
    ],
    name: 'Unstaked',
    type: 'event',
  },
  ...
  },
  {
    ...
    outputs: [{ internalType: 'uint256', name: 'less', type: 'uint256' }],
    stateMutability: 'view',
    type: 'function',
  },
  {
    inputs: [{ internalType: 'uint256', name: 'id', type: 'uint256' }],
    name: 'getLessRewradsAmount',
    outputs: [{ internalType: 'uint256', name: 'lessRewards', type: 'uint256' }],
    stateMutability: 'view',
    type: 'function',
  },
  {
  ...
  {
    inputs: [{ internalType: 'uint256', name: 'id', type: 'uint256' }],
    name: 'getLpRewradsAmount',
    outputs: [{ internalType: 'uint256', name: 'lpRewards', type: 'uint256' }],
    stateMutability: 'view',
    type: 'function',
  },
  {
  ...
  {
    inputs: [
      { internalType: 'uint8', name: 'tier2', type: 'uint8' },
      { internalType: 'uint8', name: 'tier3', type: 'uint8' },
      { internalType: 'uint8', name: 'tier4', type: 'uint8' },
      { internalType: 'uint8', name: 'tier5', type: 'uint8' },
    ],
  ...
  },
  {
    inputs: [
      ...
      { internalType: 'uint256', name: 'tier4', type: 'uint256' },
      { internalType: 'uint256', name: 'tier5', type: 'uint256' },
    ],
    name: 'setStakingTiresSums',
    outputs: [],
    stateMutability: 'nonpayable',
    type: 'function',
  },
