export default [
  ...
  {
    inputs: [{ internalType: 'uint256', name: '_totalStakedAmount', type: 'uint256' }],
    name: 'collectFee',
    outputs: [],
    stateMutability: 'nonpayable',
    type: 'function',
  ...
  },
  {
    ...
    outputs: [
      ...
      { internalType: 'uint256', name: 'openTimeVoting', type: 'uint256' },
      { internalType: 'uint256', name: 'closeTimeVoting', type: 'uint256' },
  ...
  },
  {
    ...
    outputs: [
      ...
      { internalType: 'uint256', name: 'raisedAmountBeforeLiquidity', type: 'uint256' },
